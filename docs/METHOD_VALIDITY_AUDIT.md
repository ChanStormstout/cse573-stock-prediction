...
| activity incremental v1 | `outputs/stock_activity_4h/` | `PREREGISTERED_NOT_RUN` | label-free activity audit, completed-bar/history-only feature preflight, and exact A0/R1 reproduction pass; candidate A1 is guarded and unscored | opaque-field activity is volume or has incremental four-hour predictive value |
