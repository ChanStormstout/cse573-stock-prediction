...
17 main slides and 3 appendix slides. Suggested speaking time: 10–12 minutes.
...
## Slide 14: Additional classical baselines: monthly retraining

Source: https://github.com/ChanStormstout/cse573-stock-prediction/blob/6cdb43b3d9f0c1e971081b38991eb506e6a5da0e/outputs/stock_priorwork_repro/v10/STAGE_B2_REPORT.md . These are V10 Stage B2 four-hour NEWS+PRICE joint results, using full-text word representations and price features. All three methods were frozen before Stage B2 from March–August evidence, then refitted monthly on expanding past data during September2018–February2019. Development n126 per stock; later AAPL178 and AMZN179. Unlike the August-frozen systems on the previous slide, these models incorporate newly available past labels at each monthly refit. No random split is involved. They are descriptive chronological historical comparisons, not update-policy-matched ablations of grouping. PAPER_2G_L1LR is a paper-inspired word-pair/L1 logistic model, not a full reproduction of the paper system. TFIDF_LR and TFIDF_RF are text+price joint models. Linear SVM did not enter this final frozen four-hour joint experiment; no score is supplied. No new execution occurred.

## Slide 15: What the result does and does not explain
...
## Slide 16: The course contribution is how we organize information
...
## Slide 17: Current method and next decision
...
## Slide 18: Appendix: exact representation and model
...
## Slide 19: Appendix: a repaired error and an introduced error
...
## Slide 20: Appendix: sources and scope
