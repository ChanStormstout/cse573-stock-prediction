...
## Slide 3: Baseline: average article meaning, then predict
...
## Slide 4: Why repeated reports can dominate the input
...
## Slide 5: Our method: group content and retain reporting patterns
...
## Slide 7: Two-step averaging changes the balance
...
## Slide 8: Metadata preserves the reporting pattern
...
## Slide 9: How news and prices reach the forecast
...
## Slide 10: Training uses earlier months to predict later months
...
## Slide 11: Matched comparisons isolate the mechanism
...
## Slide 12: Historical results: gains differ by stock and period

All cells read from stock_paper_methods_4h/v1/metrics.csv. F2, N0M, N1, N1M. BA percentages rounded to two decimals. Development September–October2018, later November2018–February2019. All are exposed exploratory historical results. N1M vs N0M later AAPL -0.58pp and AMZN +2.58pp. Source: https://github.com/ChanStormstout/cse573-stock-prediction/blob/06e98a766a566e8692ec41d2231f01cc611d3061/outputs/stock_paper_methods_4h/v1/REPORT.md

## Slide 13: What the result does and does not explain
...
## Slide 14: The course contribution is how we organize information
...
## Slide 15: Current method and next decision
...
## Slide 16: Appendix: exact representation and model
...
## Slide 17: Appendix: a repaired error and an introduced error
...
## Slide 18: Appendix: sources and scope
