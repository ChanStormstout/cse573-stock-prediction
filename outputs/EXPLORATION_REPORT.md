...
| 输入与模型（均含原价格） | AAPL 验证 BA | AMZN 验证 BA |
|---|---:|---:|
|标题＋稀疏词|52.72%|50.03%|
|等长正文开头＋稀疏词|56.31%|52.52%|
|公司相关句＋稀疏词|50.00%|50.04%|
|标题＋FinBERT|49.99%|50.84%|
|等长正文开头＋FinBERT|48.30%|50.04%|
|公司相关句＋FinBERT|51.93%|50.82%|
...
| 聚合方法 | AAPL 验证 BA | AMZN 验证 BA |
|---|---:|---:|
|文章等权|52.72%|50.04%|
|文章等权＋额外数量统计|52.72%|52.00%|
|近似簇等权|52.73%|50.44%|
|近似簇等权＋额外数量统计|52.73%|50.82%|
...
| 方法 | AAPL 验证 BA | AMZN 验证 BA | 两股等权平均 BA |
|---|---:|---:|---:|
|价格＋新闻数量|49.17%|49.26%|49.21%|
|价格＋FinBERT＋新闻数量|49.99%|50.84%|50.42%|
|价格＋新闻数量＋规则事件|48.71%|51.21%|49.96%|
|价格＋FinBERT＋新闻数量＋规则事件|49.11%|51.20%|50.15%|
...
|---|---|---:|
| price_count_events minus price_count | AAPL | [-5.78, +4.75] |
| price_count_events minus price_count | AMZN | [-0.79, +4.60] |
| price_count_events minus price_count | equal_stock_mean | [-2.38, +4.06] |
| price_finbert_events minus price_finbert | AAPL | [-4.64, +3.07] |
| price_finbert_events minus price_finbert | AMZN | [-2.98, +3.69] |
| price_finbert_events minus price_finbert | equal_stock_mean | [-3.09, +2.45] |
