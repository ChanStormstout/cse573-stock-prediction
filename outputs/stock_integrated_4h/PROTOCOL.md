# Integrated pipeline 4h v1 — registered before execution
...
Task: original 1607 four-hour directional windows, all original news IDs, no deletions. Source: stock_horizons/runs/v1/data.pkl, four-hour rows only; rebuild body features from original news JSON. AAPL 499/126/178 and AMZN 499/126/179 train/development/exposed-test. No one-hour labels or weights reused. Jan–Aug2018 training; monthly forward ledger March–August; outer diagnostic June–August; frozen Sept2018–Feb2019 replay, separately September–October and November onward.
...
Four-hour labels are close(t+4h)/open(t)>1 on 48 complete same-session five-minute bars. Cutoff=t-5min; news lookback4h. Intraday targets overlap; paired whole-day blocks keep that dependence. Any cache-missing title gets frozen FinBERT inference at the same revision; no encoder training on outcomes. Original runs remain untouched.
