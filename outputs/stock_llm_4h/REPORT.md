...
| 方法 | 开发：格式与字面证据通过 | 开发：匹配事实 / 9 | 开发：多抽事实 | 检查：匹配事实 / 3 |
|---|---:|---:|---:|---:|
| 既有规则 | 8/8 | 2/9 | 3 | 3/3 |
| 冻结Qwen＋少量示例 | 3/8 | 0/9 | 0 | 0/3 |
| QLoRA普通权重 | 8/8 | 0/9 | 0 | 0/3 |
| QLoRA正事件加权 | 8/8 | 1/9 | 0 | 0/3 |
| 冻结Qwen＋当前段落截断 | 5/8 | 1/9 | 0 | 0/3 |
...
|---|---|---:|---:|---:|
| selected_context | original | 3/8 | 0/9 | 0 |
| selected_context | short | 2/8 | 0/9 | 1 |
| current_context | original | 5/8 | 1/9 | 0 |
| current_context | short | 3/8 | 0/9 | 2 |
