...
完整四小时流水线已训练并保存结果，但尚未证明新组合对两只股票均有稳定提升。最新统一实验中，价格＋全文词特征在四个股票×时期单元的BA都高于50%，近期5–60分钟价格也在四个单元超过旧价格对照；两者都没有同时在四个单元超过主F0并满足概率误差护栏。当前协议仍以价格＋标题 TF-IDF＋L2 逻辑回归作为主 baseline，不能依据后续时期的最高分事后挑股票专属模型。
